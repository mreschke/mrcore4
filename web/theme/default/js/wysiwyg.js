...
if (!wysiwyg_toolbarButtons) {
	...
	//["formatblock", "Code", "<code>", "Code Format"],
	["div"], // place a toolbar divider
...
//[/<pre>(.*?)<\/pre>/gm, "\n<code>\n$1\n</code>\n"]
	...
	[/\ /gim, "&nbsp;"],
	//Code Tag
	[/\&lt;code\&gt\;/gim, "<span class='tag_code_data'><span class='tag_code'>&lt;code&gt;</span>"],
	[/\&lt;code&nbsp;(.*?)\&gt;/gim, "<span class='tag_code_data'><span class='tag_code'>&lt;code&nbsp;$1&gt;</span>"],
	[/\&lt;&#47;code\&gt;/gim, "<span class='tag_code_end'>&lt;&#47;code&gt;</span></span>"],
	//html tag
	...
	//phpw tag
	[/\&lt;phpw\&gt;/gim, "<span class='tag_php_data'><span class='tag_php'>&lt;phpw&gt;</span>"],
	[/\&lt;&#47;phpw\&gt;/gim, "<span class='tag_php'>&lt;/phpw&gt;</span></span>"],
	//codepress tag
	...
	[/\&lt;&#47;box\&gt;/gim, "<span class='tag_box_end'>&lt;/box&gt;</span></span>"],
	//priv tag
	...
	//info tag
	[/\&lt;info\&gt;/gim, "<span class='tag_info_data'><span class='tag_info'>&lt;info&gt;</span>"],
	[/\&lt;&#47;info\&gt;/gim, "<span class='tag_info'>&lt;/info&gt;</span></span>"],
	//toc tag
	[/\[\[toc\]\]/gim, "<span class='tag_toc'>[[toc]]</span>"],
	//files tag
	[/\&lt;files(.*?)\&gt;/gim, "<span class='tag_files'>&lt;files$1&gt;</span>"],
	//Bold
	[/\'\'\'(.*?)\'\'\'/gim, "<b>$1</b>"],
	...
	[/\-\-\-\-\n/gim, "<hr />"],
	//Links
	[/\&#40;\&#40;(.*?)\|(.*?)\&#41;\&#41;/gim, "<span class='tag_link'>(($1|$2))</span>"],
	[/\&#40;\&#40;(.*?)\&#41;\&#41;/gim, "<span class='tag_link'>(($1))</span>"],
	[/\[\[\#(.*?)\]\]/gim, "<span class='tag_anchor'>[[#$1]]</span>"],
	[/(&nbsp;|\n|\[)local:(.*?)(&nbsp;|\n|\])/gim, "$1<span class='tag_link'>local:$2</span>$3"],
	[/(&nbsp;|\n|\[)http(.*?):&#47;&#47;(.*?)(&nbsp;|\n|\])/gim, "$1<span class='tag_link'>http$2://$3</span>$4"],
	[/(&nbsp;|\n)mailto:(.*?)(&nbsp;|\n)/gi, "$1<span class='tag_link'>mailto:$2</span>$3"],
	//Image
	[/\[\[image(.*?)\]\]/gi, "<span class='tag_image'>[[image$1]]</span>"],
	//Color
	[/\#\#(.*?)\|(.*?)\#\#/gim, "<font color=\"$1\">$2</font>"],
	[/\#\#(.*?)\|([\s\S]*)\#\#/gim, "<font color=\"$1\">$2</font>"],
	//Teletype
	[/\{\{(.*?)\}\}/gim, "<span class='tag_tt'>{{$1}}</span>"],
	//Blockquote
