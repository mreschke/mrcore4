...
class Text_Wiki_Render_Xhtml_Code extends Text_Wiki_Render {
    ...
    */
    ...
    function token($options)
    {
        ...
        $title = $attr['title']; //mReschke
        $linenum = strtolower($attr['linenum']); //mReschke
		$height = strtolower($attr['height']); //mReschke
        ...
        if ($type != '') {
            ...
            if ($title == '') $title = strtoupper($type).' Code Snippet';
			...
			if ($height) {
		    	$text = "<div$css_outer><span$css_header>$title</span><div style='height:${height}px;overflow:auto;'>$text</div></div>";
			} else {
	            $text = "<div$css_outer><span$css_header>$title</span>$text</div>";
			}
        } else {
            //Geshi Plain Text
			...
			if ($height) {
				$text = "<div$css_outer><span$css_header>$title</span><pre$css style='height:${height}px;overflow:auto;'><code$css_code>$text</code></pre></div>";
			} else {
