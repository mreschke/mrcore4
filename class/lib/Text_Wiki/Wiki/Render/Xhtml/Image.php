    ...
    */
    ...
    function token($options)
    {
        ...
        if (isset($options['attr']['link'])) {
            ...
            } elseif (strtolower(substr($options['attr']['link'], 0, 6)) == 'local:') {
                #mReschke Addition for link="local:/somepage"
                $href = substr($options['attr']['link'], 6);
                #echo "<b>$href</b>";
        ...
        /*mreschke commented, don't like now it resizes 2011-09-08
