...
class Text_Wiki_Render_Xhtml_Heading extends Text_Wiki_Render {
    ...
    function token($options)
    {
        ...
        if ($collapsed !== null && $collapse_link) {
            ...
            $collapse_link_html .= '<span class="header_collapse"><a href="javascript:toggle_wiki_headers(true);" title="Collapse All">[--]</a></span>';
            $collapse_link_html .= '<span class="header_expand"><a href="javascript:toggle_wiki_headers(false);" title="Expand All">[++]</a></span>';
        }
            ...
            switch($type) {
                ...
                case 'end':
                    if ($collapse_link) {
                        ...
                        $ret .= $collapse_link_html.'</h'.$level.'><a href="#top"><div class="heading_top"></div></a>';
                    } else {
                        $ret .= $collapse_link_html.'</h'.$level.'><a href="#top"><div class="heading_top"></div></a>';
                    }
                    return $ret;
                case 'startContent':
                    ...
                    return '<div class="header'.$level.'_content" style="'.($collapsed === true ? 'display: none; ' : 'display: block').'" id="'.$id.'__content">'.$div;
                case 'endContent':
