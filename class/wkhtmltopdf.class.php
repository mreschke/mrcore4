...
#If you had wkhtmltophp installed on this qserver you could convert a page to PDF with
#eval(Page::load_class('wkhtmltopdf'));
...
$GLOBALS['WKPDF_BASE_SITE'] = Config::WEB_BASE_URL.'/';
